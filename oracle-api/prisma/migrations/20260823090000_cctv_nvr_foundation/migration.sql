...
CREATE TABLE "CameraProfile" (
  ...
  "installationDate" TIMESTAMP(3), "notes" TEXT, "idempotencyKey" TEXT, "idempotencyPayloadHash" TEXT, "networkInterfaceId" TEXT,
...
ALTER TABLE "CameraProfile" ADD CONSTRAINT "CameraProfile_networkInterfaceId_fkey" FOREIGN KEY ("networkInterfaceId") REFERENCES "NetworkInterface"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
CREATE TABLE "RecorderChannel" (
  ...
  "enabled" BOOLEAN NOT NULL DEFAULT true, "portId" TEXT, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX "RecorderChannel_portId_idx" ON "RecorderChannel"("portId");
...
ALTER TABLE "RecorderChannel" ADD CONSTRAINT "RecorderChannel_portId_fkey" FOREIGN KEY ("portId") REFERENCES "NetworkPort"("id") ON DELETE SET NULL ON UPDATE CASCADE;
